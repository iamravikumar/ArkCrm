...
namespace ARK.BUSINESS.Core
{
    ...
    public class DependencyRegistrar : IDependencyRegistrar
    {
        ...
        public virtual void Register(ContainerBuilder builder, ITypeFinder typeFinder, ArkConfig config)
        {
            //file provider
            builder.RegisterType<ArkFileProvider>().As<IArkFileProvider>().InstancePerLifetimeScope();
