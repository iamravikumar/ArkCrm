//using ARK.BUSINESS.Core;
//using ARK.BUSINESS.Http;
...
//        private readonly IArkFileProvider _fileProvider;
...
//                    var forwardedHttpHeaderKey = ArkHttpDefaults.XForwardedForHeader;
...
//                return _httpContextAccessor.HttpContext.Request.Headers[ArkHttpDefaults.HttpClusterHttpsHeader].ToString().Equals("on", StringComparison.OrdinalIgnoreCase);

//            //use HTTP_X_FORWARDED_PROTO?
//            if (_hostingConfig.UseHttpXForwardedProto)
//                return _httpContextAccessor.HttpContext.Request.Headers[ArkHttpDefaults.HttpXForwardedProtoHeader].ToString().Equals("https", StringComparison.OrdinalIgnoreCase);
...
//            if (!success)
//            {
//                throw new ArkException("nopCommerce needs to be restarted due to a configuration change, but was unable to do so." + Environment.NewLine +
...
//            get
//            {
//                if (_httpContextAccessor.HttpContext.Items[ArkHttpDefaults.IsPostBeingDoneRequestItem] == null)
//                    return false;

//                return Convert.ToBoolean(_httpContextAccessor.HttpContext.Items[ArkHttpDefaults.IsPostBeingDoneRequestItem]);
//            }

//            set => _httpContextAccessor.HttpContext.Items[ArkHttpDefaults.IsPostBeingDoneRequestItem] = value;
//        }
